...
namespace Rock.Migrations
{
    ...
    ///
    /// </summary>
    public partial class AttributeUpdate : Rock.Migrations.RockMigration
    {
        /// <summary>
        ...
        public override void Up()
        {
            ...
            AddColumn("dbo.ContentChannel", "ContentItemPublishingPoint", c => c.String(defaultValue: "{{ ''Global'' | ''InternalApplicationRoot'' }}/ContentChannelItem/{{ Id }}" ) );
