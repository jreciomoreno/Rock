            ...
            if ( !errorMessages.Any() )
            {
                ...
                { 
                    ...
                    else
                    {
                        ...
                        if ( document == null )
                        {
                            string documentKey = provider.SendDocument( rockContext, signatureDocumentType, email, out sendErrors );
                        ...
                        {
                            provider.ResendDocument( rockContext, document, email, out sendErrors );
                        }
